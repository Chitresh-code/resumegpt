...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getSupportedFormat(gl: WebGLRenderingContext, internalFormat: number, format: number, type: number | null): any {
    ...
    function supportRenderTextureFormat(gl: WebGLRenderingContext, internalFormat: number, format: number, type: number | null): boolean {
      ...
      gl.texImage2D(gl.TEXTURE_2D, 0, internalFormat, 4, 4, 0, format, type as number, null);
    ...
    function createFBO(w: number, h: number, internalFormat: number, format: number, type: number | null, param: number) {
      ...
      gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
      gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
      gl.texImage2D(gl.TEXTURE_2D, 0, internalFormat, w, h, 0, format, type as number, null);
    ...
    function createDoubleFBO(w: number, h: number, internalFormat: number, format: number, type: number | null, param: number) {
    ...
    function resizeFBO(target: any, w: number, h: number, internalFormat: number, format: number, type: number | null, param: number) {
    ...
    function resizeDoubleFBO(target: any, w: number, h: number, internalFormat: number, format: number, type: number | null, param: number) {
  ...
  return (
    <div className="fixed top-0 left-0 z-0 pointer-events-none w-screen h-screen">
      <canvas 
        ref={canvasRef} 
        id="fluid" 
